...
BOT_USERNAME = environ.get("BOT_USERNAME", "HK_PS_Bot") # without @
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://harikushal.blogspot.com/2024/11/hari-blogger.html") # For More Information Check Video On Yt - @Tech_VJ
